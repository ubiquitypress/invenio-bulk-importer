...
class ImporterTaskDetailView(AdminResourceDetailView):
    """Admin importer task detail view."""

    url = "/importer-tasks/<pid_value>"
    name = "importer-tasks-details"
    resource_config = "tasks_resource"
    title = "Bulk Importer Task Details"
    api_endpoint = "/importer-tasks"
    template = "invenio_bulk_importer/administration/importer_task_details.html"
